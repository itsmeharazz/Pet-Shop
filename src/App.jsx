...
import {
  Area, Bar, Calender, ColorMapping, ColorPicker, Customer,
  Ecommerce, Editor, Employee, Financial, Kanban, Line,
...
// Syncfusion license
registerLicense("ORg4AjUWIQA/Gnt2XFhhQlJHfV5AQmBIYVp/TGpJfl96cVxMZVVBJAtUQF1hTH5WdENiXXtadH1TRmheWkZ/");
...
function App() {
  ...
  const isAdminRoute = location.pathname.startsWith("/admin") ||
    ...
    location.pathname.startsWith("/color-picker") ||
    location.pathname.startsWith("/line") ||
    location.pathname.startsWith("/area") ||
    location.pathname.startsWith("/bar") ||
    location.pathname.startsWith("/pie") ||
    location.pathname.startsWith("/financial") ||
    location.pathname.startsWith("/color-mapping") ||
    location.pathname.startsWith("/pyramid") ||
    location.pathname.startsWith("/stacked");

  return (
    <>
      {/* Show login popup and navbar only on user pages */}
      {!isAdminRoute && showLogin && <SignInPopUp setShowLogin={setShowLogin} />}
